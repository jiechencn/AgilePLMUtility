 ...
 */
public class OIDBean extends AttrsBean{
    ...
    public void build() {
        ...
        setIfNull(DAConstants.ATT_USER_FROM_NAME_FILTER, "(&(cn=%u)(objectClass=person))");
        setIfNull(DAConstants.ATT_USER_NAME_ATTRIBUTE, "cn");
        setIfNull(DAConstants.ATT_USER_OBJECT_CLASS, "person");
        setIfNull(DAConstants.ATT_GROUP_FROM_NAME_FILTER, "(|(&(cn=%g)(objectclass=groupofuniquenames))(&(cn=%g)(objectclass=orcldynamicgroup)))");
        ...
        setIfNull(DAConstants.ATT_GUID_ATTRIBUTE, "orclGUID");
        setIfNull(DAConstants.ATT_USER_ENTRY_DN_ATTRIBUTE, "dn");
        super.build();
    }
