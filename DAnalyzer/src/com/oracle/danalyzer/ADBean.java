 ...
 */
public class ADBean extends AttrsBean {
    ...
    public void build() {
        ...
        setIfNull(DAConstants.ATT_USER_FROM_NAME_FILTER, "(&(sAMAccountName=%u)(objectClass=user))");
        setIfNull(DAConstants.ATT_USER_NAME_ATTRIBUTE, "sAMAccountName");
