...
public class Client {
    ...
    public static void main(String[] args) {
        ...
        attrs.put(DAConstants.ATT_LDAP_PROVIDER, DAConstants.SERVER_ACTIVE_DIR_SERVICE);
        attrs.put(DAConstants.ATT_URL, "ldap://10.64.204.161:389");
        attrs.put(DAConstants.ATT_PRINCIPAL, "user2@mycompany.com");
        ...
        //attrs.put(DAConstants.ATT_USER_SEARCH_SCOPE, "SUB_TREE");
        
        
        // below are optional fields. If not input, DAnalyzer uses default values.
        /*
        ...
        attrs.put(DAConstants.ATT_GROUP_SEARCH_SCOPE, "SUB_TREE");
        ...
        */
        ...
        da = new DAnalyzer(attrs);
        da.loadUsers();
        da.verifyLogon("user5", "Oracle1");
        da.verifyApproval("user3", "Oracle1");
        da.readLdifByName("grpu[p7", false);
        out = da.outputReport();
        saveLog2HTMLReport("d:\\hello2.html", out);
        saveLog2TextReport("d:\\hello2.txt", out);
        da.release(); 
